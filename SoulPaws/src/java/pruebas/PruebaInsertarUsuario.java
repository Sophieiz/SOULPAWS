...
public class PruebaInsertarUsuario {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        usuarios.setfecha_nac(java.sql.Date.valueOf(fechaNac));

        java.time.LocalDate fechaCad = java.time.LocalDate.now().plusYears(1);
        usuarios.setfecha_cad(java.sql.Date.valueOf(fechaCad));

        usuarios.setcheckbox(true);
